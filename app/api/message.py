...
BackgroundTasksDep = Annotated[BackgroundTasks, Depends(get_background_tasks)]
DBDep = Annotated[UsersDB, Depends(get_users_db)]
LLMDep = Annotated[LLMPort, Depends(get_llm_adapter)]
InstagramDep = Annotated[InstagramPort, Depends(get_aiograpi_adapter)]
...
async def process_message(
    ...
    return {"msg": "Notification sent to bot in background."}
